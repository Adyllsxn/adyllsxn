...
const useContactForm = ()=>{
    ...
    const formatName = (value, field)=>{
        // Permite apenas letras, espaços e acentos
        const cleaned = value.replace(/[^a-zA-ZÀ-ÿ\s]/g, '');
        // Limita o número de caracteres baseado no campo
        const maxLength = field === 'firstName' ? 20 : 30;
        const truncated = cleaned.slice(0, maxLength);
        return truncated.toLowerCase().split(' ').map((word)=>word.charAt(0).toUpperCase() + word.slice(1)).join(' ').replace(/\s+/g, ' ') // Remove múltiplos espaços
        .trim();
    };
    ...
    const handleChange = (name, value)=>{
        ...
        if (name === 'firstName' || name === 'lastName') {
            formattedValue = formatName(value, name);
        } else if (name === 'email') {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const formattedData = {
                ...formData,
                firstName: formatName(formData.firstName, 'firstName'),
                lastName: formatName(formData.lastName, 'lastName'),
                email: formatEmail(formData.email)
            };
            console.log('📤 Enviando para FormSubmit...', formattedData);
            // Cria FormData para enviar
            const formDataToSend = new FormData();
            formDataToSend.append('name', `${formattedData.firstName} ${formattedData.lastName}`.trim());
            formDataToSend.append('email', formattedData.email);
            formDataToSend.append('subject', `Portfolio: ${formattedData.subject}`);
            formDataToSend.append('message', formattedData.message);
            formDataToSend.append('_captcha', 'false');
            formDataToSend.append('_template', 'table');
            formDataToSend.append('_replyto', formattedData.email);
...
function Contact() {
    const { theme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$ThemeContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTheme"])();
    const { language } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$LanguageContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLanguage"])();
    const { formData, isSubmitting, submitStatus, handleChange, handleSubmit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useContactForm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContactForm"])();
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                                        ...
                                        children: [
                                            ...
                                            submitStatus === 'success' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                                                ...
                                                className: "mb-6 p-4 rounded-xl bg-green-500/20 border border-green-500/30",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "font-medium",
                                                            children: language === 'pt' ? '✅ Mensagem enviada com sucesso! Entrarei em contato em breve.' : '✅ Message sent successfully! I\'ll contact you soon.'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/sections/Contact.tsx",
                                                            lineNumber: 267,
                                                            columnNumber: 21
                                            ...
                                            submitStatus === 'error' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "font-medium",
                                                            children: language === 'pt' ? '❌ Erro ao enviar mensagem. Tente novamente.' : '❌ Error sending message. Please try again.'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/sections/Contact.tsx",
                                                            lineNumber: 285,
                                                            columnNumber: 21
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                        ...
                                                                        pattern: "[a-zA-ZÀ-ÿ\\s]+",
                                                                        title: language === 'pt' ? 'Apenas letras e espaços são permitidos' : 'Only letters and spaces are allowed'
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/components/sections/Contact.tsx",
                                                                        lineNumber: 304,
                                                                        columnNumber: 21
...
//# sourceMappingURL=src_a4d72132._.js.map